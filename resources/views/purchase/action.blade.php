...
<div class="modal fade text-left" id="default-delete{{$purchase->id}}" tabindex="-1" purchase="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <form class="form" method="DELETE" action="{{route('purchase.destroy', $purchase->id)}}" enctype="multipart/form-data">
